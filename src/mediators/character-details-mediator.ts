...
import { SearchActionsQuerystring, SearchActorQuerystring, SearchAllyQuerystring, SearchCharactersQuerystring, SearchHouseQuerystring, SearchQuerystring, SearchRelationshipsQuerystring } from "../routes/schemas";
import * as characterManager from "../managers/character-manager";
import * as actorManager from "../managers/actor-manager";
import { request } from "http";
import _ from "lodash";

export async function getDetails({app, searchQuery }: {app: FastifyInstance, searchQuery: SearchQuerystring}) {
